...
<li>
   ...
   <input type=" checkbox radio" name="thanhtoan-khi-nhanhang" />
   <label >Thanh toán khi nhận hàng</label>
</li>
  <li>
  <label ></label>
  <input type=" checkboxradio" name="thanhtoan-momo" class="momo" />
   <label >Thanh toán qua MoMo</label>
   </li>
   <li>
  <label ></label>
  <input type="checkbox radio" name="thanhtoan-VNPay"  class="vnpay" />
