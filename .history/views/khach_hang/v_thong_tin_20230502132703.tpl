...
<li>
      ...
      <select name="phai" class="thanhtoan">
        <option value="1" {if $kh->phai == 1}  selected="selected" {/if}>Thanh toán khi nhận hàng</option>
        <option value="0" {if $kh->phai == 0}  selected="selected" {/if}>Thanh toán qua MoMo</option>
        <option value="0" {if $kh->phai == 0}  selected="selected" {/if}>Thanh toán qua VNPAY</option>
      </select>
  </li>
  <li>
